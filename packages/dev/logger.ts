 ...
 *
 * Provides structured, colorful logging with log levels.
 */
...
/**
 * Logger interface for Kage development.
 */
 ...
 * @example
 * ```typescript
 * const log = createLogger({ level: "debug", prefix: "kage" });
...
export function createLogger(options: {
  ...
  const log = (level: LogLevel, color: string, message: string, args: unknown[]): void => {
